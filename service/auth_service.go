...
// NewAuthService is used to create a single instance of the service_mock
...
// AddUser is a service_mock layer that helps to add new user
func (a *authService) AddUser(user *models.User) (*models.User, error) {
	return a.AuthRepo.AddUser(user)
}

// GetUserByEmail is a service_mock layer that helps to check user by their email
